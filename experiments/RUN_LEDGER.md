...
Generated 2026-09-10 14:33 by `scripts/build_run_ledger.py`. Rebuild it after every run, and **always before deleting a checkpoint**.
...
**58 runs · 30 checkpoints currently on disk**
...
| `unet_resnet34_30ep_20260910_083614` | solar | train | 5 | **0.8519** | 5 | 0.9200 | 0.9207 | 0.9194 |
