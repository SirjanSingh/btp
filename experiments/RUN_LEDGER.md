...
Generated 2026-09-10 21:30 by `scripts/build_run_ledger.py`. Rebuild it after every run, and **always before deleting a checkpoint**.
...
| `unet_resnet34_30ep_20260910_142120` | rooftop | train | 21 | **0.8696** | 19 | 0.9303 | 0.9331 | 0.9274 |
