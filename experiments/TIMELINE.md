...
*Generated 2026-09-12 16:26 by `scripts/build_timeline.py`. Do not edit by hand — rerun the script.*
...
**[`2026-09-11-d10-missed-gallery`](2026-09-11-d10-missed-gallery/)** — ✅ done — refutes an assumption I made in D8
>
> **Expected:** the large misses will show a small number of recurring, physical causes, most likely low-contrast flat roofs and tree/building shadow.

**[`2026-09-11-d11-overlap-rule`](2026-09-11-d11-overlap-rule/)** — ★ done — rule inflates miss rate 1.77×; large-building misses are artefact
> **Why:** if miss rate collapses as the threshold relaxes, the 33 % figure is largely an artefact of a constant nobody chose deliberately, and the "largest remaining error in Stage 1" framing that has driven the last several experiments is wrong. That would be worth knowing before anyone spends a 3-hour arm on it.
>
> **Expected:** . I over-estimated the artefact. 2. "Fall proportionally larger for big buildings" ✅ — and decisively: **−81 %** for 2000+ against **−17 %** for 50–200. 3. "Residual floor ≥ 5 %" ✅ — **16.0 %** remains even at 5 % overlap.
...
**[`2026-09-11-d14-energy-budget`](2026-09-11-d14-energy-budget/)** — ★★ done — segmentation is 1.7 % of the uncertainty
> **Why:** the project's prime directive is energy (kWh/yr), not segmentation. If segmentation contributes a few percent of the output variance and `k_usable` contributes twenty, then no amount of further segmentation work can move the headline figure — and the last day of diagnostics, however sound, was spent on the wrong term.
...
212 commits. Each is a unit of work — a run launched, a result recorded, a bug found, a document corrected.

### 2026-09-12  ·  16 commits

- `15:26` **e039f7c** Regenerate ledger and timeline
- `14:26` **ba707d3** Regenerate ledger and timeline
- `13:26` **1bf1d6c** Regenerate ledger and timeline
- `12:26` **3dd12b5** Regenerate ledger and timeline
- `11:26` **2161256** Regenerate ledger and timeline
- `10:26` **3549665** Regenerate ledger and timeline
- `09:26` **9d8d052** Regenerate ledger and timeline
- `08:26` **6002893** Regenerate ledger and timeline
- `07:26` **6ed9a36** Regenerate ledger and timeline
- `06:26` **7350522** Regenerate ledger and timeline
- `05:26` **4ab0288** Regenerate ledger and timeline
- `04:26` **64c594f** Regenerate ledger and timeline
- `03:26` **a852ea6** Regenerate ledger and timeline
- `02:26` **030e7f2** Regenerate ledger and timeline
- `01:26` **8e99528** Regenerate ledger and timeline
- `00:27` **729dfcf** Regenerate ledger and timeline

### 2026-09-11  ·  62 commits

- `23:27` **2ab3f3e** Regenerate ledger and timeline
- `22:58` **8d7029f** Persist day 2: session note, reasoning notes, memory
- `22:29` **4044451** Regenerate ledger and timeline
- `22:00` **fe9eb25** Regenerate ledger and timeline
- `21:58` **7b8eb05** Regenerate ledger and timeline
- `21:29` **57ef6c0** Regenerate ledger and timeline
- `21:00` **0cf94aa** Regenerate ledger and timeline
- `20:58` **ec3fd56** Regenerate ledger and timeline
- `20:29` **7ebd581** Regenerate ledger and timeline
- `20:00` **f75aac8** Regenerate ledger and timeline
- `19:58` **9ce13db** Regenerate ledger and timeline
- `19:29` **046b717** Regenerate ledger and timeline
...
- `18:07` **f0b868c** D16: first end-to-end figure -- 4.59 GWp / 7.62 TWh/yr, and a 14.3% error caught
...
- `17:03` **39ae4e6** D13: the model's extra small components are not fragments
